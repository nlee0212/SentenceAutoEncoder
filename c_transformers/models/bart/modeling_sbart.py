...
class BartDecoderLayer(nn.Module):
    ...
    def forward(
        ...
        # print('Encoder hidden state in DecoderLayer')
        # print(encoder_hidden_states.size())

        if encoder_hidden_states.dim() != 3:
            for i in range(3-encoder_hidden_states.dim()):
                encoder_hidden_states = encoder_hidden_states.unsqueeze(dim=-2)

        # print('Encoder hidden state after unsqueezing')
        # print(encoder_hidden_states.size())
    ...
    def forward(
        ...
        if input_ids is not None and inputs_embeds is not None:
            ...
            if inputs_embeds.dim() == 2:
                inputs_embeds = inputs_embeds.unsqueeze(dim=-2)
...
class BartModel(BartPretrainedModel):
    ...
    def forward(
        ...
        # print(encoder_outputs[0][:,:,0].unsqueeze(dim=-1).size())
